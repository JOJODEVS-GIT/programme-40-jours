...
import { mathsGeneralesChapters, chapterContents } from "@/data/maths-generales"
...
export default function MathsGeneralesChapterPage({
  params,
}: {
  ...
  const chapter = mathsGeneralesChapters.find((c) => c.slug === slug)

  if (!chapter) {
    return (
      <div className="space-y-4">
        <Link
          href="/maths-generales"
